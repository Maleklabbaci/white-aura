            ...
            <form onSubmit={handleAddProduct} className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label className="flex-1 flex items-center justify-center gap-2 border-2 border-dashed border-gray-300 px-4 py-3 text-sm hover:border-gold-400 hover:bg-gold-50 transition-colors cursor-pointer">
